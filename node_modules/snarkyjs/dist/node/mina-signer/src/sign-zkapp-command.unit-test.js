...
import { isReady, Ledger, Scalar as ScalarSnarky, shutdown, } from '../../snarky.js';
...
import { AccountUpdate, Field, ZkappCommand, } from '../../provable/gen/transaction-bigint.js';
...
test(RandomTransaction.zkappCommandAndFeePayerKey, ({ feePayerKey, zkappCommand }) => {
    ...
    let sigTestnetOcaml = Ledger.signFieldElement(ocamlCommitments.fullCommitment, feePayerKeySnarky, false);
    let sigMainnetOcaml = Ledger.signFieldElement(ocamlCommitments.fullCommitment, feePayerKeySnarky, true);
