...
test(RandomTransaction.signedPayment, RandomTransaction.signedDelegation, (payment, delegation) => {
    ...
    let v1Bytes0 = stringToBytesOcaml(Ledger.encoding.ofBase58(ocamlBase58V1, versionBytes.signedCommandV1).c);
    ...
    v1Bytes0 = stringToBytesOcaml(Ledger.encoding.ofBase58(ocamlBase58V1, versionBytes.signedCommandV1).c);
...
shutdown();
function paymentToOcaml({ data: { common, body: { source, receiver, amount }, }, signature, }) {
    return {
        payload: {
...
function paymentToOcamlV1({ data: { common, body: { source, receiver, amount }, }, signature, }) {
    return {
        payload: {
...
function delegationToOcaml({ data: { common, body: { delegator, newDelegate }, }, signature, }) {
    return {
        payload: {
            common: commonToOcaml(common),
            body: [
...
function delegationToOcamlV1({ data: { common, body: { delegator, newDelegate }, }, signature, }) {
    return {
        payload: {
            common: commonToOcamlV1(common),
            body: [
