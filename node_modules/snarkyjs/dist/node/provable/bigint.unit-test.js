...
function testBigintRoundtrip(x, size) {
...
expect(() => bigIntToBytes(100000n, 2)).toThrow(/does not fit in 2 bytes/);
expect(() => bigIntToBytes(4n * Field.modulus, 32)).toThrow(/does not fit in 32 bytes/);
console.log('bigint unit tests are passing! 🎉');
shutdown();
//# sourceMappingURL=bigint.unit-test.js.map