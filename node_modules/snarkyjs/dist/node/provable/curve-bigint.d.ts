import { GroupProjective } from '../js_crypto/elliptic_curve.js';
...
declare const PublicKey: {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("../js_crypto/non-negative.js").NonNegativeInteger<N>): [value: {
        x: bigint;
        isOdd: Bool;
    }, offset: number];
