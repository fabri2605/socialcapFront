...
import { Field, Gate, Pickles, Provable, ProvablePure } from '../snarky.js';
...
export { SmartContract, method, DeployArgs, signFeePayer, declareMethods, Callback, Account, VerificationKey, Reducer, };
/**
...
declare class SmartContract {
    ...
    static Proof(): {
        new ({ proof, publicInput, maxProofsVerified, }: {
            ...
            proof: unknown;
            maxProofsVerified: 0 | 2 | 1;
            shouldVerify: Types.Bool;
            verify(): void;
            verifyIf(condition: Types.Bool): void;
            toJSON(): {
                publicInput: string[];
                maxProofsVerified: 0 | 2 | 1;
                proof: string;
     ...
     */
    get balance(): {
        addInPlace(x: string | number | bigint | Types.UInt64 | Types.UInt32 | import("./int.js").Int64): void;
        subInPlace(x: string | number | bigint | Types.UInt64 | Types.UInt32 | import("./int.js").Int64): void;
    };
    /**
