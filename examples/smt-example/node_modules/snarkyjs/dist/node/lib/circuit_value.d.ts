...
export { Circuit, CircuitValue, ProvableExtended, prop, arrayProp, matrixProp, public_, circuitMain, provable, provablePure, Struct, FlexibleProvable, FlexibleProvablePure, };
export { AnyConstructor, cloneCircuitValue, circuitValueEquals, circuitArray, memoizationContext, memoizeWitness, getBlindingValue, toConstant, isConstant, InferProvable, HashInput, InferJson, InferredProvable, };
...
declare function circuitArray<A extends FlexibleProvable<any>>(elementType: A, length: number): InferredProvable<A[]>;
