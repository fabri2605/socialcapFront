...
import { FlexibleProvable, FlexibleProvablePure, InferProvable } from './circuit_value.js';
...
declare class Proof<T> {
    ...
    toJSON(): JsonProof;
    static fromJSON<S extends Subclass<typeof Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, }: JsonProof): Proof<InferProvable<S['publicInputType']>>;
...
declare function ZkProgram<PublicInputType extends FlexibleProvablePure<any>, Types extends {
...
declare namespace ZkProgram {
    var Proof: <PublicInputType extends FlexibleProvablePure<any>>(program: {
        name: string;
        publicInputType: PublicInputType;
    }) => {
        ...
        fromJSON<S extends Subclass<typeof import("./proof_system.js").Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, }: JsonProof): Proof<InferProvable<S["publicInputType"]>>;
    };
}
...
type Prover<PublicInput, Args extends Tuple<PrivateInput>> = (publicInput: PublicInput, ...args: TupleToInstances<Args>) => Promise<Proof<PublicInput>>;
