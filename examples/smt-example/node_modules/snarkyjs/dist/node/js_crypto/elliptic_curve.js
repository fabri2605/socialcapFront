...
function createCurveProjective(p, generator, endoBase, endoScalar, b) {
    return {
        zero: projectiveZero,
        one: generator,
        endoBase,
...
const Pallas = createCurveProjective(p, pallasGeneratorProjective, pallasEndoBase, pallasEndoScalar, b);
const Vesta = createCurveProjective(q, vestaGeneratorProjective, vestaEndoBase, vestaEndoScalar, b);
