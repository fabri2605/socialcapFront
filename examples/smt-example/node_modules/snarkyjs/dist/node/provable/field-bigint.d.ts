...
export { pseudoClass, ProvableExtended, HashInput, ProvableBigint, BinableBigint, sizeInBits, checkRange, checkField, };
type Field = bigint;
type Bool = 0n | 1n;
type UInt32 = bigint;
type UInt64 = bigint;
...
declare const Field: ((value: bigint | number | string) => bigint) & {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("../js_crypto/non-negative.js").NonNegativeInteger<N>): [value: bigint, offset: number];
...
declare const Bool: ((value: boolean) => Bool) & {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("../js_crypto/non-negative.js").NonNegativeInteger<N>): [value: Bool, offset: number];
...
declare const Sign: ((value: 1 | -1) => Sign) & {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("../js_crypto/non-negative.js").NonNegativeInteger<N>): [value: Sign, offset: number];
