...
export const MerkleMapLeafUpdateArgsSchema: z.ZodType<Prisma.MerkleMapLeafUpdateArgs> = z.object({
  select: MerkleMapLeafSelectSchema.optional(),
  include: MerkleMapLeafIncludeSchema.optional(),
  data: z.union([ MerkleMapLeafUpdateInputSchema,MerkleMapLeafUncheckedUpdateInputSchema ]),
  where: MerkleMapLeafWhereUniqueInputSchema,
}).strict()

export default MerkleMapLeafUpdateArgsSchema;
