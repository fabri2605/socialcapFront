...
import { MerkleMapLeafUpdateInputSchema } from '../inputTypeSchemas/MerkleMapLeafUpdateInputSchema'
import { MerkleMapLeafUncheckedUpdateInputSchema } from '../inputTypeSchemas/MerkleMapLeafUncheckedUpdateInputSchema'
...
export const MerkleMapLeafUpsertArgsSchema: z.ZodType<Prisma.MerkleMapLeafUpsertArgs> = z.object({
  ...
  create: z.union([ MerkleMapLeafCreateInputSchema,MerkleMapLeafUncheckedCreateInputSchema ]),
  update: z.union([ MerkleMapLeafUpdateInputSchema,MerkleMapLeafUncheckedUpdateInputSchema ]),
}).strict()

export default MerkleMapLeafUpsertArgsSchema;
