...
import { MembersUncheckedUpdateManyWithoutCommunityNestedInputSchema } from './MembersUncheckedUpdateManyWithoutCommunityNestedInputSchema';
...
export const CommunityUncheckedUpdateInputSchema: z.ZodType<Prisma.CommunityUncheckedUpdateInput> = z.object({
  ...
  Members: z.lazy(() => MembersUncheckedUpdateManyWithoutCommunityNestedInputSchema).optional()
}).strict();
