...
export const PersonUncheckedCreateWithoutMembersInputSchema: z.ZodType<Prisma.PersonUncheckedCreateWithoutMembersInput> = z.object({
  uid: z.string().max(32),
...
export default PersonUncheckedCreateWithoutMembersInputSchema;
