...
import { MembersUpdateManyWithoutCommunityNestedInputSchema } from './MembersUpdateManyWithoutCommunityNestedInputSchema';
...
export const CommunityUpdateInputSchema: z.ZodType<Prisma.CommunityUpdateInput> = z.object({
  ...
  Members: z.lazy(() => MembersUpdateManyWithoutCommunityNestedInputSchema).optional()
}).strict();
