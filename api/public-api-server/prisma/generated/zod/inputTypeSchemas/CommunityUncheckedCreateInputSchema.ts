...
import { z } from 'zod';
import { MembersUncheckedCreateNestedManyWithoutCommunityInputSchema } from './MembersUncheckedCreateNestedManyWithoutCommunityInputSchema';
...
export const CommunityUncheckedCreateInputSchema: z.ZodType<Prisma.CommunityUncheckedCreateInput> = z.object({
  ...
  Members: z.lazy(() => MembersUncheckedCreateNestedManyWithoutCommunityInputSchema).optional()
}).strict();
