...
import { MembersUncheckedUpdateManyWithoutPersonNestedInputSchema } from './MembersUncheckedUpdateManyWithoutPersonNestedInputSchema';
...
export const PersonUncheckedUpdateInputSchema: z.ZodType<Prisma.PersonUncheckedUpdateInput> = z.object({
  ...
  Members: z.lazy(() => MembersUncheckedUpdateManyWithoutPersonNestedInputSchema).optional()
}).strict();

export default PersonUncheckedUpdateInputSchema;
